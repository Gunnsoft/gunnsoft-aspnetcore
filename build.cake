...
Task("Publish")
    ...
    .Does(() => 
    {
        var exitCode = StartProcess("dotnet", new ProcessSettings
        {
            Arguments = $@"pack src\Gunnsoft.AspNetCore --configuration {configuration} --no-restore /p:Version={version}"
        });
...
Task("Copy")
    ...
    .Does(() =>
    {
        ...
        CopyFile($@".\src\Gunnsoft.AspNetCore\bin\{configuration}\Gunnsoft.AspNetCore.{version}.nupkg", $@"{artifactsDirectory}\gunnsoft-aspnetcore.nupkg"); 
